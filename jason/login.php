                                    ...
                                    <div class="login-wrap">
                                        <form name="login" id="login" method="post" action="./login_response.php">
                                            <ul>
                                                <li>
                                                    <div>
                                                        <label for="email">이메일</label><div><input type="email" name="email" id="email" value="" placeholder="등록된 이메일을 입력하세요."></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div>
                                                ...
                                                <li>
                                                    <div class="clearfix">
                                                        <span class="left-wrap">아직 회원이 아니신가요?<a href="#" class="join">회원가입</a></span>
                                                        <span class="right-wrap"><a href="#" class="idPwdFind">아이디/비밀번호 찾기</a></span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div>
